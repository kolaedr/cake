...
@section('content')
    ...
    {!! Form::model($CakeFillings, ['url'=>'admin/cake-fillings','class'=>'col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10']) !!}
    {{-- {{Form::token()}} --}}
    @include('admin.cakefilling._form')

    <div class="row align-items-center">
        {!! Form::submit('Add', ['class'=>'btn btn-primary']) !!}
        <a href="{{route('cake-fillings.index')}}" class="ml-3">back</a>
    </div>
    {!! Form::close() !!}
@endsection
