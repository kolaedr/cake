...
<div class="row justify-content-between">
    <h1>Categories</h1>
    <a href="{{route('categories.create')}}" class="btn btn-primary"><i class="fas fa-plus nav-icon mr-3"></i>Add new</a>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-inline-flex">
                <a href="{{route('categories.edit', $item->id)}}" class="text-secondary mr-3" title="Edit"><i class="fas fa-edit nav-icon"></i></a>
                ...
                <form action="/admin/ccategories/{{$item->id}}" method="POST">
                    @csrf
                    @method('DELETE')
